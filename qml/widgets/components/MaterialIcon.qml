...
QtObject {
    ...
    readonly property string iconBatteryAlert:    "\ue19c" // battery with "!" \u2014 BMS low-soc flag on the battery info rows
    readonly property string iconAutorenew:       "\ue863" // cycle arrows \u2014 cycle counts on the battery info rows
