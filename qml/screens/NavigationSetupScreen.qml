...
Rectangle {
    ...
    readonly property bool mapsOk: NavAvailability.localDisplayMapsAvailable
    readonly property bool routingOk: NavAvailability.routingAvailable
    ...
    // Connectivity
    readonly property bool isOnline: InternetStore.modemState === 2
    readonly property bool hasGps: GpsStore.gpsState === 2
    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                Text {
                    Layout.alignment: Qt.AlignHCenter
                    text: Translations.navSetupDownloadProgress.arg(Math.round(navSetupScreen.dlProgress * 100))
                    color: navSetupScreen.textPrimary
                    font.pixelSize: ThemeStore.fontBody
                }
                ...
                Text {
                    Layout.alignment: Qt.AlignHCenter
                    text: Translations.navSetupDownloadProgressBytes
