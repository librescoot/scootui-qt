...
Rectangle {
    ...
    readonly property bool mapsAvailable: NavAvailability.localDisplayMapsAvailable
    ...
    ColumnLayout {
        ...
        Item {
            ...
            Repeater {
                model: SavedLocationsStore.locations
                delegate: Item {
            ...
            Rectangle {
                ...
                Text {
                    id: coordText
                    anchors.centerIn: parent
                    text: MapService.mapLatitude.toFixed(5) + ", " + MapService.mapLongitude.toFixed(5)
                    color: "white"
