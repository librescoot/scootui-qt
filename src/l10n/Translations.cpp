...
void Translations::initStrings()
{
    ...
    en[QStringLiteral("keycardEnrollDetail")] = QStringLiteral("New cards are queued during enrollment and saved when you choose Done. Existing or repeated cards are not added again.");
    de[QStringLiteral("keycardEnrollDetail")] = QStringLiteral("Neue Karten werden beim Anlernen vorgemerkt und mit Fertig gespeichert. Bereits bekannte oder wiederholte Karten werden nicht erneut hinzugefügt.");
    en[QStringLiteral("keycardDetectedCount")] = QStringLiteral("Detected this session: %1");
    de[QStringLiteral("keycardDetectedCount")] = QStringLiteral("In dieser Sitzung erkannt: %1");
