...
enum class ScreenMode { Cluster, Map, CarPlay, Debug, About, Maintenance, Ota, AddressSelection, Simulator, NavigationSetup, Faults, UpdateModeInfo, HopOnInfo, MotionDebug, SystemInfo, UpdateChannel };
