...
enum class ScreenMode { Cluster, Map, CarPlay, Debug, About, Maintenance, Ota, AddressSelection, Simulator, NavigationSetup, Destination, Faults, UpdateModeInfo, HopOnInfo, MotionDebug, SystemInfo };
