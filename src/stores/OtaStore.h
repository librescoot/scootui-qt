...
class OtaStore : public SyncableStore
{
    ...
    Q_PROPERTY(QString dbcErrorHistory READ dbcErrorHistory NOTIFY dbcErrorHistoryChanged)
    ...
    Q_PROPERTY(QString mdbErrorHistory READ mdbErrorHistory NOTIFY mdbErrorHistoryChanged)
...
public:
    ...
    QString dbcErrorHistory() const { return m_dbcErrorHistory; }
    ...
    QString mdbErrorHistory() const { return m_mdbErrorHistory; }
