...
public:
    ...
    static InternetStore *create(QQmlEngine *, QJSEngine *)
    {
        Q_ASSERT(s_qmlInstance);
        QJSEngine::setObjectOwnership(s_qmlInstance, QJSEngine::CppOwnership);
        return s_qmlInstance;
    }
    static void setQmlInstance(InternetStore *instance) { s_qmlInstance = instance; }

private:
    static inline InternetStore *s_qmlInstance = nullptr;
};
