...
void Application::createStores(QQmlApplicationEngine &engine)
{
    ...
    InternetStore::setQmlInstance(internetStore);
    ModemStore::setQmlInstance(modemStore);
    NavigationStore::setQmlInstance(navigationStore);
    SettingsStore::setQmlInstance(settingsStore);
    OtaStore::setQmlInstance(otaStore);
    UsbStore::setQmlInstance(usbStore);
    SpeedLimitStore::setQmlInstance(speedLimitStore);
    AutoStandbyStore::setQmlInstance(autoStandbyStore);
    ScooterStore::setQmlInstance(scooterStore);
    CbBatteryStore::setQmlInstance(cbBatteryStore);
    AuxBatteryStore::setQmlInstance(auxBatteryStore);
    ScreenStore::setQmlInstance(screenStore);
    MenuStore::setQmlInstance(menuStore);
    HopOnStore::setQmlInstance(hopOnStore);
    TripStore::setQmlInstance(tripStore);
    ShutdownStore::setQmlInstance(shutdownStore);
    LocaleStore::setQmlInstance(localeStore);
    ShortcutMenuStore::setQmlInstance(shortcutMenuStore);
    Translations::setQmlInstance(m_translations);
    SettingsService::setQmlInstance(m_settingsService);
    NavigationService::setQmlInstance(m_navigationService);

    // New context properties
    ConnectionStore::setQmlInstance(connectionStore);
    DashboardStore::setQmlInstance(dashboardStore);
    ToastService::setQmlInstance(m_toastService);
    MapService::setQmlInstance(m_mapService);
    InputHandler::setQmlInstance(m_inputHandler);
    NavigationAvailabilityService::setQmlInstance(m_navAvailability);
    SavedLocationsStore::setQmlInstance(savedLocationsStore);
    RecentDestinationsStore::setQmlInstance(recentDestinationsStore);
    SerialNumberService::setQmlInstance(m_serialNumberService);
    AddressDatabaseService::setQmlInstance(m_addressDatabaseService);
    RoadInfoService::setQmlInstance(m_roadInfoService);
    MapDownloadService::setQmlInstance(m_mapDownloadService);
    UmsLogStore::setQmlInstance(umsLogStore);
    SystemInfoService::setQmlInstance(m_systemInfoService);
    OdometerMilestoneService::setQmlInstance(m_odometerMilestoneService);
